...
> Åbn denne side på [https://mcstigdk.github.io/rgb-tune/](https://mcstigdk.github.io/rgb-tune/)
...
* søg efter **https://github.com/mcstigdk/rgb-tune**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/mcstigdk/rgb-tune/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/mcstigdk/rgb-tune**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/mcstigdk/rgb-tune/raw/master/.github/makecode/blocks.png)
